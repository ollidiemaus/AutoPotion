...
L["Configure the behavior of the addon. IE: if you want to include class spells"] = "Настройте поведение аддона. IE: если вы хотите включить классовые заклинания"
...
L["Includes the shortest Cooldown in the reset Condition of Castsequence. !!USE CAREFULLY!!"] = "Включает в себя самое короткое время восстановления в состоянии сброса последовательности заклинаний. !!ИСПОЛЬЗУЙТЕ ОСТОРОЖНО!!"
...
L["Reset to Default"] = "Сброс к настройкам по умолчанию"
