...
-- Forever is Vanilla-based; reuse the Classic Era list until beta testing shows otherwise.
function ham.getDrinkForForever()
  return {
    ...
    ham.conjuredWater,
    -- Dual restore (health AND mana, no stats) - shared with Core/Food/Forever.lua's list
    ham.essenceMango,
